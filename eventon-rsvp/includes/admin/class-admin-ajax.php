	...
	// GET list of attendees for event
		...
		function each_attendee_data_row($_id, $rsvp, $text){
			...
			<p data-rsvpid='<?php echo $_id;?>'>
				...
				<span class='checkin <?php echo $checkable?'evors_trig_checkin ':''; echo $status_var;?>' data-id='<?php echo $_id;?>' data-status='<?php echo $status_var;?>' data-nonce="<?php echo wp_create_nonce(AJDE_EVCAL_BASENAME);?>"><?php echo $_status;?></span>
