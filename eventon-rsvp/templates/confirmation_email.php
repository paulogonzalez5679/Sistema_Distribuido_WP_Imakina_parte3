	...
	<tr>
		<td style='<?php echo $__sty_td;?>'>
			<div style="padding:45px 20px; font-family:'open sans',Helvetica">
				<p style='<?php echo $__sty_lh;?>font-size:18px; font-style:italic; margin:0'><?php echo EVORS()->lang('evoRSLX_009', 'You have RSVP-ed', $lang)?></p>
				...
				?>
				<p><a style='<?php echo $__styles_button;?>' href='<?php echo admin_url();?>admin-ajax.php?action=eventon_ics_download&event_id=<?php echo $EVENT->ID;?>&sunix=<?php echo $adjusted_event_times['start'];?>&eunix=<?php echo $adjusted_event_times['end'] . $location;?>' target='_blank'><?php echo EVORS()->lang('evcal_evcard_addics', 'Add to calendar', $lang);?></a></p>
			</div>
		</td>
	</tr>
	<tr>
