		...
		if (has_post_thumbnail() || $lshowcase_options['lshowcase_default_image'] != '' || $custom_img_url != ''):
			...
			if ($activeurl != "inactive" && $url != "" ) {
				...
				*/
				...
				$html.= "<img data-original-title='".get_the_title()."' data-entry-id='".get_the_ID()."' src='" . $image[0] . "' ".$srcset." width='" . $width . "' ".$height." alt='" . $alt . "' title='" . $title . "' class='lshowcase-thumb'  ".$instyle." />";
