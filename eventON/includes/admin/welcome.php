			...
			<div class='evo_welcome_page'>	
				<div class="wrap about-wrap eventon-welcome-box">
					<div id='eventon_welcome_header'>			
						<p class='logo'>
							...
							<img src='<?php echo AJDE_EVCAL_URL?>/assets/images/welcome/welcome_screen_logo.png'/><span>WordPress Event Calendar</span></p>
					</div>
				...
				<div class='get_started'>
					<div class="get_started_in">
						<h2>
							<a class='evo_admin_btn btn_prime' href='<?php echo admin_url('index.php?page=evo-getting-started');?>'>Get started with EventON</a>
